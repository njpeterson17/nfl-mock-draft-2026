        ...
        const bigBoardData = [
            ...
            { rank: 52, name: "Caleb Tiernan", position: "OT", school: "Northwestern", tier: "Round 2" },
            { rank: 53, name: "Ja'Kobi Lane", position: "WR", school: "USC", tier: "Round 2" },
            { rank: 54, name: "Julian Neal", position: "CB", school: "Arkansas", tier: "Round 2" },
            { rank: 55, name: "Carson Beck", position: "QB", school: "Miami", tier: "Round 2" },
            { rank: 56, name: "Deontae Lawson", position: "LB", school: "Alabama", tier: "Round 2" },
            { rank: 57, name: "Connor Lew", position: "C", school: "Auburn", tier: "Round 2" },
            { rank: 58, name: "Gracen Halton", position: "DT", school: "Oklahoma", tier: "Round 2" },
            { rank: 59, name: "Trinidad Chambliss", position: "QB", school: "Ole Miss", tier: "Round 2" },
            { rank: 60, name: "Chris Johnson", position: "CB", school: "San Diego State", tier: "Round 2" },
            { rank: 61, name: "Emmanuel Pregnon", position: "OG", school: "Oregon", tier: "Round 2" },
            { rank: 62, name: "Chris Bell", position: "WR", school: "Louisville", tier: "Round 2" },
            { rank: 63, name: "Max Klare", position: "TE", school: "Ohio State", tier: "Round 2" },
            { rank: 64, name: "Davison Igbinosun", position: "CB", school: "Ohio State", tier: "Round 2" },
            { rank: 65, name: "Chris Brazzell II", position: "WR", school: "Tennessee", tier: "Round 2" },
            { rank: 66, name: "Joe Royer", position: "TE", school: "Cincinnati", tier: "Round 2" },
            { rank: 67, name: "Ar'Maj Reed-Adams", position: "OG", school: "Texas A&M", tier: "Round 2" },
            { rank: 68, name: "Germie Bernard", position: "WR", school: "Alabama", tier: "Round 2" },
            { rank: 69, name: "Eli Stowers", position: "TE", school: "Vanderbilt", tier: "Round 3" },
            { rank: 70, name: "Nicholas Singleton", position: "RB", school: "Penn State", tier: "Round 3" },
            { rank: 71, name: "Kyle Louis", position: "LB", school: "Pittsburgh", tier: "Round 3" },
            { rank: 72, name: "Darrell Jackson Jr.", position: "DT", school: "Florida State", tier: "Round 3" },
            { rank: 73, name: "Aamil Wagner", position: "OT", school: "Notre Dame", tier: "Round 3" },
            { rank: 74, name: "Devin Moore", position: "CB", school: "Florida", tier: "Round 3" },
            { rank: 75, name: "Dani Dennis-Sutton", position: "EDGE", school: "Penn State", tier: "Round 3" },
            { rank: 76, name: "Billy Schrauth", position: "OG", school: "Notre Dame", tier: "Round 3" },
            { rank: 77, name: "A.J. Haulcy", position: "S", school: "LSU", tier: "Round 3" },
            { rank: 78, name: "Derrick Moore", position: "EDGE", school: "Michigan", tier: "Round 3" },
            { rank: 79, name: "Logan Jones", position: "C", school: "Iowa", tier: "Round 3" },
            { rank: 80, name: "Dallen Bentley", position: "TE", school: "Utah", tier: "Round 3" },
            { rank: 81, name: "D'Angelo Ponds", position: "CB", school: "Indiana", tier: "Round 3" },
            { rank: 82, name: "Isaiah World", position: "OT", school: "Oregon", tier: "Round 3" },
            { rank: 83, name: "Elijah Sarrett", position: "WR", school: "Indiana", tier: "Round 3" },
            { rank: 84, name: "Malachi Lawrence", position: "EDGE", school: "UCF", tier: "Round 3" },
            { rank: 85, name: "Malik Muhammad", position: "CB", school: "Texas", tier: "Round 3" },
            { rank: 86, name: "Zakee Wheatley", position: "S", school: "Penn State", tier: "Round 3" },
            { rank: 87, name: "Drew Shelton", position: "OT", school: "Penn State", tier: "Round 3" },
            { rank: 88, name: "Cameron Ball", position: "DT", school: "Arkansas", tier: "Round 3" },
            { rank: 89, name: "Jake Slaughter", position: "C", school: "Florida", tier: "Round 3" },
            { rank: 90, name: "Dametrious Crownover", position: "OT", school: "Texas A&M", tier: "Round 3" },
            { rank: 91, name: "Kamari Ramsey", position: "S", school: "USC", tier: "Round 3" },
            { rank: 92, name: "Jacob Rodriguez", position: "LB", school: "Texas Tech", tier: "Round 3" },
            { rank: 93, name: "Tim Keenan III", position: "DT", school: "Alabama", tier: "Round 3" },
            { rank: 94, name: "Joshua Josephs", position: "EDGE", school: "Tennessee", tier: "Round 3" },
            { rank: 95, name: "Charles Demmings", position: "CB", school: "Stephen F. Austin", tier: "Round 3" },
            { rank: 96, name: "Sam Roush", position: "TE", school: "Stanford", tier: "Round 3" },
            { rank: 97, name: "Skyler Gill-Howard", position: "DT", school: "Texas Tech", tier: "Round 3" },
            { rank: 98, name: "LT Overton", position: "EDGE", school: "Alabama", tier: "Round 3" },
            { rank: 99, name: "Austin Barber", position: "OT", school: "Florida", tier: "Round 3" },
            { rank: 100, name: "Jalon Kilgore", position: "S", school: "South Carolina", tier: "Round 3" },
            { rank: 101, name: "Kaytron Allen", position: "RB", school: "Penn State", tier: "Round 3" },
            { rank: 102, name: "Roman Hemby", position: "RB", school: "Indiana", tier: "Round 3" },
            { rank: 103, name: "Jack Endries", position: "TE", school: "Texas", tier: "Round 3" },
            { rank: 104, name: "Nishad Strother", position: "OG", school: "Texas", tier: "Round 4" },
            { rank: 105, name: "Nadame Tucker", position: "EDGE", school: "Western Michigan", tier: "Round 4" },
            { rank: 106, name: "Chris McClellan", position: "DT", school: "Missouri", tier: "Round 4" },
            { rank: 107, name: "Daylen Everette", position: "CB", school: "Georgia", tier: "Round 4" },
            { rank: 108, name: "Darius Taylor", position: "RB", school: "Minnesota", tier: "Round 4" },
            { rank: 109, name: "Drew Allar", position: "QB", school: "Penn State", tier: "Round 4" },
            { rank: 110, name: "Maxwell Burton", position: "OT", school: "Texas A&M", tier: "Round 4" },
            { rank: 111, name: "Dillon Bell", position: "WR", school: "Georgia", tier: "Round 4" },
            { rank: 112, name: "Kevin Winston Jr.", position: "S", school: "Penn State", tier: "Round 4" },
            { rank: 113, name: "Oluwafemi Oladejo", position: "OG", school: "UCLA", tier: "Round 4" },
            { rank: 114, name: "Aireontae Ersery", position: "OT", school: "Minnesota", tier: "Round 4" },
            { rank: 115, name: "Rahsul Faison", position: "RB", school: "South Carolina", tier: "Round 4" },
            { rank: 116, name: "Marcus Washington", position: "WR", school: "Texas", tier: "Round 4" },
            { rank: 117, name: "Jonah Coleman", position: "RB", school: "Washington", tier: "Round 4" },
            { rank: 118, name: "Matayo Uiagalelei", position: "EDGE", school: "Oregon", tier: "Round 4" },
            { rank: 119, name: "Rod Moore", position: "S", school: "Michigan", tier: "Round 4" },
            { rank: 120, name: "Chase Bisontis", position: "OG", school: "Texas A&M", tier: "Round 4" },
            ...
            { rank: 123, name: "Zane Durant", position: "DT", school: "Penn State", tier: "Round 5" },
            { rank: 124, name: "Michael Trigg", position: "TE", school: "Baylor", tier: "Round 5" },
            { rank: 125, name: "Jayden Higgins", position: "WR", school: "Iowa State", tier: "Round 5" },
            { rank: 126, name: "Tacario Davis", position: "CB", school: "Arizona", tier: "Round 5" },
            { rank: 127, name: "Josiah Trotter", position: "LB", school: "Missouri", tier: "Round 5" },
            { rank: 128, name: "Sawyer Robertson", position: "QB", school: "Baylor", tier: "Round 5" },
            { rank: 129, name: "Darien Porter", position: "CB", school: "Iowa State", tier: "Round 5" },
            { rank: 130, name: "Mike Washington Jr.", position: "RB", school: "Arkansas", tier: "Round 5" },
            { rank: 131, name: "Kaleb Proctor", position: "DT", school: "SE Louisiana", tier: "Round 5" },
            { rank: 132, name: "Cole Payton", position: "QB", school: "North Dakota State", tier: "Round 5" },
            { rank: 133, name: "Will Hardy", position: "CB", school: "Notre Dame", tier: "Round 5" },
            { rank: 134, name: "Carson Schwesinger", position: "LB", school: "UCLA", tier: "Round 5" },
            { rank: 135, name: "Justin Joly", position: "TE", school: "NC State", tier: "Round 5" },
            { rank: 136, name: "Garrett Nussmeier", position: "QB", school: "LSU", tier: "Round 5" },
            { rank: 137, name: "Tyreese Fearbry", position: "EDGE", school: "Pittsburgh", tier: "Round 5" },
            { rank: 138, name: "Jalon Walker", position: "LB", school: "Georgia", tier: "Round 5" },
            { rank: 139, name: "Dontay Corleone", position: "DT", school: "Cincinnati", tier: "Round 5" },
            { rank: 140, name: "Isaiah Bond", position: "WR", school: "Texas", tier: "Round 5" },
            { rank: 141, name: "Javon Kilgore", position: "S", school: "South Carolina", tier: "Round 5" },
            { rank: 142, name: "Jaylon Guilbeau", position: "CB", school: "Texas", tier: "Round 5" },
            { rank: 143, name: "Lander Barton", position: "LB", school: "Utah", tier: "Round 5" },
            { rank: 144, name: "Nick Singleton", position: "RB", school: "Penn State", tier: "Round 5" },
            { rank: 145, name: "Alex Harkey", position: "OT", school: "Oregon", tier: "Round 5" },
            { rank: 146, name: "Sebastian Castro", position: "CB", school: "Iowa", tier: "Round 5" },
            { rank: 147, name: "Evan Stewart", position: "WR", school: "Oregon", tier: "Round 5" },
            { rank: 148, name: "Derrick Harmon", position: "DT", school: "Oregon", tier: "Round 5" },
            { rank: 149, name: "Oscar Delp", position: "TE", school: "Georgia", tier: "Round 5" },
            { rank: 150, name: "Jalen Royals", position: "WR", school: "Utah State", tier: "Round 6" },
            { rank: 151, name: "Jake Johnson", position: "OG", school: "Iowa", tier: "Round 6" },
            { rank: 152, name: "Jalon Catalon", position: "S", school: "UNLV", tier: "Round 6" },
            { rank: 153, name: "Brandon Turnage", position: "CB", school: "Alabama", tier: "Round 6" },
            { rank: 154, name: "Jordan Burch", position: "DT", school: "Oregon", tier: "Round 6" },
            { rank: 155, name: "Dorian Strong", position: "CB", school: "Virginia Tech", tier: "Round 6" },
            { rank: 156, name: "Sam Hecht", position: "C", school: "Kansas State", tier: "Round 6" },
            { rank: 157, name: "Cole Hutson", position: "LB", school: "Oklahoma State", tier: "Round 6" },
            { rank: 158, name: "Theo Wease Jr.", position: "WR", school: "Ole Miss", tier: "Round 6" },
            { rank: 159, name: "Mikail Kamara", position: "EDGE", school: "Indiana", tier: "Round 6" },
            { rank: 160, name: "DeShon Singleton", position: "S", school: "Nebraska", tier: "Round 6" },
            { rank: 161, name: "Jared Wilson", position: "OT", school: "Georgia", tier: "Round 6" },
            { rank: 162, name: "Devin Neal", position: "RB", school: "Kansas", tier: "Round 6" },
            { rank: 163, name: "Jett Elad", position: "OG", school: "Colorado", tier: "Round 6" },
            { rank: 164, name: "Damieon George", position: "OG", school: "Florida", tier: "Round 6" },
            { rank: 165, name: "Hezekiah Masses", position: "CB", school: "California", tier: "Round 6" },
            { rank: 166, name: "Will Mallory", position: "TE", school: "Miami", tier: "Round 6" },
            { rank: 167, name: "Ted Hurst", position: "TE", school: "Georgia State", tier: "Round 6" },
            { rank: 168, name: "Raul Aguirre", position: "OT", school: "TCU", tier: "Round 6" },
            { rank: 169, name: "Anthony Lucas", position: "EDGE", school: "Arkansas", tier: "Round 6" },
            { rank: 170, name: "Brian Parker II", position: "C", school: "Duke", tier: "Round 6" },
            { rank: 171, name: "Peny Boone", position: "DT", school: "Maryland", tier: "Round 6" },
            { rank: 172, name: "Elic Ayomanor", position: "WR", school: "Stanford", tier: "Round 6" },
            { rank: 173, name: "D.Q. Smith", position: "S", school: "South Carolina", tier: "Round 6" },
            { rank: 174, name: "T.J. Sanders", position: "LB", school: "South Carolina", tier: "Round 6" },
            { rank: 175, name: "Kitan Crawford", position: "CB", school: "NC State", tier: "Round 6" },
            { rank: 176, name: "Rara Thomas", position: "WR", school: "Troy", tier: "Round 6" },
            { rank: 177, name: "Mason Murphy", position: "OG", school: "Auburn", tier: "Round 6" },
            { rank: 178, name: "Trey Moore", position: "EDGE", school: "UTSA", tier: "Round 6" },
            { rank: 179, name: "Jaylen Reed", position: "S", school: "Penn State", tier: "Round 6" },
            { rank: 180, name: "Bryce Cosby", position: "WR", school: "Ball State", tier: "Round 6" },
            { rank: 181, name: "Tony Grimes", position: "CB", school: "Purdue", tier: "Round 7" },
            { rank: 182, name: "Josh Proctor", position: "S", school: "Ohio State", tier: "Round 7" },
            { rank: 183, name: "Treshaun Ward", position: "RB", school: "Florida State", tier: "Round 7" },
            { rank: 184, name: "Brayden Schager", position: "QB", school: "Hawaii", tier: "Round 7" },
            { rank: 185, name: "Savion Red", position: "EDGE", school: "Rutgers", tier: "Round 7" },
            { rank: 186, name: "Sataoa Laumea", position: "OT", school: "Utah", tier: "Round 7" },
            { rank: 187, name: "Brenen Thompson", position: "WR", school: "Mississippi State", tier: "Round 7" },
            { rank: 188, name: "Chandler Rivers", position: "CB", school: "Duke", tier: "Round 7" },
            { rank: 189, name: "Ben Yurosek", position: "TE", school: "Georgia Tech", tier: "Round 7" },
            { rank: 190, name: "Jaheim Singletary", position: "OG", school: "Georgia", tier: "Round 7" },
            { rank: 191, name: "Ashton Gillotte", position: "EDGE", school: "Louisville", tier: "Round 7" },
            { rank: 192, name: "Jacquez Jones", position: "CB", school: "Kentucky", tier: "Round 7" },
            { rank: 193, name: "Romello Height", position: "EDGE", school: "Texas Tech", tier: "Round 7" },
            { rank: 194, name: "Isaiah Williams", position: "LB", school: "Illinois", tier: "Round 7" },
            { rank: 195, name: "Sam Hartman", position: "QB", school: "Notre Dame", tier: "Round 7" },
            { rank: 196, name: "JaCorey Thomas", position: "S", school: "Georgia", tier: "Round 7" },
            { rank: 197, name: "Terrance Ferguson", position: "TE", school: "Oregon", tier: "Round 7" },
            { rank: 198, name: "Coltin Wright", position: "CB", school: "Stanford", tier: "Round 7" },
            { rank: 199, name: "Grey Zabel", position: "C", school: "North Dakota State", tier: "Round 7" },
            { rank: 200, name: "DeVonta Smith", position: "CB", school: "Notre Dame", tier: "Round 7" },
            { rank: 201, name: "Emmett Johnson", position: "RB", school: "Nebraska", tier: "Round 7" },
            { rank: 202, name: "Parker Brailsford", position: "C", school: "Alabama", tier: "Round 7" },
            { rank: 203, name: "Marcus Harris", position: "S", school: "Auburn", tier: "Round 7" },
            { rank: 204, name: "Branson Robinson", position: "RB", school: "Georgia", tier: "Round 7" },
            { rank: 205, name: "Nate Clifton", position: "OT", school: "Purdue", tier: "Round 7" },
            { rank: 206, name: "Jaylen Sneed", position: "LB", school: "South Carolina", tier: "Round 7" },
            { rank: 207, name: "Kaden Wetjen", position: "WR", school: "Iowa", tier: "Round 7" },
            { rank: 208, name: "Mitchell Agude", position: "EDGE", school: "Miami", tier: "Round 7" },
            { rank: 209, name: "Gavin Bartholomew", position: "TE", school: "Wisconsin", tier: "Round 7" },
            { rank: 210, name: "Ajani Cornelius", position: "OT", school: "Oregon", tier: "Round 7" }
        ];
        // ==========================================
        ...
        const positionalRankings = {
            ...
            OT: [
                ...
                { rank: 6, name: "Kage Casey", school: "Boise State", overallRank: 55, grade: 84.0, oneLineSummary: "Massive frame with power but needs technique work." },
