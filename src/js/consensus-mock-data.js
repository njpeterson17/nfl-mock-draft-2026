...
const ConsensusMockData = {
    ...
    teams: {
        ...
        5: { name: 'New York Giants', code: 'NYG', record: '4-13', needs: ['Interior DL', 'QB', 'WR'] },
        6: { name: 'Cleveland Browns', code: 'CLE', record: '5-12', needs: ['CB', 'WR', 'S'] },
        7: { name: 'Washington Commanders', code: 'WAS', record: '5-12', needs: ['DE', 'CB', 'LB'] },
        8: { name: 'New Orleans Saints', code: 'NO', record: '6-11', needs: ['WR', 'OT', 'CB'] },
        9: { name: 'Kansas City Chiefs', code: 'KC', record: '6-11', needs: ['Pass rusher', 'WR', 'CB'] },
        10: { name: 'Cincinnati Bengals', code: 'CIN', record: '6-11', needs: ['Interior DL', 'OT', 'LB'] },
        11: { name: 'Miami Dolphins', code: 'MIA', record: '7-10', needs: ['IOL', 'EDGE', 'CB'] },
        12: { name: 'Dallas Cowboys', code: 'DAL', record: '7-9-1', needs: ['Defense', 'WR', 'RB'] },
        13: { name: 'Baltimore Ravens', code: 'BAL', record: '8-9', needs: ['EDGE', 'CB', 'WR'] },
        14: { name: 'Tampa Bay Buccaneers', code: 'TB', record: '8-9', needs: ['EDGE', 'S', 'LB'] },
        15: { name: 'Indianapolis Colts', code: 'IND', record: '9-8', needs: ['WR', 'EDGE', 'CB'] },
        16: { name: 'Atlanta Falcons', code: 'ATL', record: '9-8', needs: ['EDGE', 'CB', 'WR'] },
        17: { name: 'Chicago Bears', code: 'CHI', record: '8-9', needs: ['EDGE', 'IOL', 'WR'] },
        18: { name: 'Minnesota Vikings', code: 'MIN', record: '9-8', needs: ['OT', 'WR', 'CB'] },
        19: { name: 'Los Angeles Chargers', code: 'LAC', record: '11-6', needs: ['IOL', 'DL', 'CB'] },
        20: { name: 'Kansas City Chiefs', code: 'KC', record: '11-6', needs: ['Pass rusher', 'WR', 'CB'] },
        21: { name: 'Arizona Cardinals', code: 'ARI', record: '11-6', needs: ['OT', 'DL', 'EDGE'] },
        22: { name: 'Seattle Seahawks', code: 'SEA', record: '12-5', needs: ['IOL', 'DL', 'LB'] },
        23: { name: 'Buffalo Bills', code: 'BUF', record: '12-5', needs: ['WR', 'CB', 'EDGE'] },
        24: { name: 'Houston Texans', code: 'HOU', record: '12-5', needs: ['RB', 'WR', 'DL'] },
        ...
        32: { name: 'Detroit Lions', code: 'DET', record: '15-2', needs: ['IOL', 'LB', 'CB'] }
    },
