...
const PLAYER_DATABASE = [
    ...
    { name: 'Ty Simpson', position: 'QB', school: 'Alabama', rank: 2, edp: 8.5, height: "6'2\"", weight: 208, forty: '4.73', analysis: 'Athletic QB with strong arm and mobility.', strengths: ['Great pocket presence', 'High football IQ', 'Can beat defenses with legs'] },
    { name: 'Jeremiyah Love', position: 'RB', school: 'Notre Dame', rank: 3, edp: 6.7, height: "6'0\"", weight: 214, forty: '4.45', analysis: 'Explosive RB with elite receiving ability.', strengths: ['Reggie Bush-like dynamo', 'Elite vision', 'Receiving threat'] },
    { name: 'Carnell Tate', position: 'WR', school: 'Ohio State', rank: 4, edp: 5.8, height: "6'3\"", weight: 195, forty: '4.43', analysis: 'Tall, precise route runner with excellent hands.', strengths: ['Size and body control', 'Contested catches', '17.2 YPC'] },
    { name: 'Arvell Reese', position: 'LB', school: 'Ohio State', rank: 5, edp: 4.2, height: "6'4\"", weight: 243, forty: '4.60', analysis: 'Elite athlete with Micah Parsons upside.', strengths: ['Elite burst', 'Pass-rush ability', 'Versatile'] },
    ...
    { name: 'David Bailey', position: 'EDGE', school: 'Texas Tech', rank: 7, edp: 8.9, height: "6'3\"", weight: 250, forty: '4.58', analysis: 'Elite speed rusher with first-step quickness.', strengths: ['Elite get-off', 'Bend', 'Explosive'] },
    ...
    { name: 'Caleb Downs', position: 'S', school: 'Ohio State', rank: 9, edp: 9.6, height: "6'0\"", weight: 205, forty: '4.45', analysis: 'Defensive coordinator on the field.', strengths: ['Elite instincts', 'Versatility', 'Tackling'] },
    { name: 'Jordyn Tyson', position: 'WR', school: 'Arizona State', rank: 10, edp: 11.8, height: "6'2\"", weight: 200, forty: '4.48', analysis: 'Explosive receiver who wins 50/50 balls.', strengths: ['Contested catches', 'Red zone threat', 'Route savvy'] },
    { name: 'Makai Lemon', position: 'WR', school: 'USC', rank: 11, edp: 10.5, height: "5'11\"", weight: 190, forty: '4.40', analysis: 'Warrior with RB body and elite slot ability.', strengths: ['Quickness', 'YAC ability', 'Toughness'] },
    { name: 'Sonny Styles', position: 'LB', school: 'Ohio State', rank: 12, edp: 15.8, height: "6'4\"", weight: 243, forty: '4.55', analysis: 'Former safety with elite speed for a LB.', strengths: ['Coverage ability', 'Sideline-to-sideline', 'Modern LB'] },
    { name: 'Peter Woods', position: 'DL', school: 'Clemson', rank: 13, edp: 9.2, height: "6'3\"", weight: 315, forty: '5.05', analysis: 'Day-one starter at 3-technique.', strengths: ['Gap penetration', 'Quickness', 'High motor'] },
    { name: 'Jermod McCoy', position: 'CB', school: 'Tennessee', rank: 14, edp: 13.1, height: "6'0\"", weight: 193, forty: '4.40', analysis: 'Lockdown corner with 4.40 speed.', strengths: ['Press-man', 'Ball skills', 'Recovery speed'] },
    { name: 'Trinidad Chambliss', position: 'QB', school: 'Ole Miss', rank: 15, edp: 12.4, height: "6'1\"", weight: 205, forty: '4.75', analysis: 'Athletic playmaker with strong arm.', strengths: ['Mobility', 'Competitive', 'Arm strength'] },
    { name: 'Akheem Mesidor', position: 'EDGE', school: 'Miami', rank: 16, edp: 16.7, height: "6'3\"", weight: 280, forty: '4.75', analysis: 'Powerful edge setter with relentless motor.', strengths: ['Power rush', 'Run defense', 'Versatility'] },
    ...
    { name: 'Kayden McDonald', position: 'DL', school: 'Ohio State', rank: 18, edp: 14.6, height: "6'3\"", weight: 326, forty: '5.12', analysis: 'Massive gap-eater who demands double teams.', strengths: ['Elite size', 'Gap-eating', 'Anchor'] },
    { name: 'Ty Simpson', position: 'QB', school: 'Alabama', rank: 19, edp: 19.5, height: "6'2\"", weight: 210, forty: '4.73', analysis: 'Arm talent with mobility and upside.', strengths: ['Arm strength', 'Athleticism', 'Upside'] },
    { name: 'Olaivavega Ioane', position: 'IOL', school: 'Penn State', rank: 20, edp: 19.8, height: "6'4\"", weight: 330, forty: '5.25', analysis: 'Dominant LG with strength and agility.', strengths: ['Power', 'Anchor', 'Run blocking'] },
    { name: 'Keldric Faulk', position: 'EDGE', school: 'Auburn', rank: 21, edp: 12.1, height: "6'6\"", weight: 285, forty: '4.80', analysis: 'Perfect 4-3 DE frame with powerful hands.', strengths: ['Length', 'Strength', 'Run defense'] },
    { name: 'Drew Allar', position: 'QB', school: 'Penn State', rank: 22, edp: 18.3, height: "6'5\"", weight: 235, forty: '4.82', analysis: 'Prototypical size with cannon arm.', strengths: ['Size', 'Arm strength', 'Pocket passer'] },
    { name: 'Spencer Fano', position: 'OT', school: 'Utah', rank: 23, edp: 14.2, height: "6'6\"", weight: 302, forty: '5.15', analysis: 'Technically sound with good punch.', strengths: ['Technique', 'Footwork', 'Zone fit'] },
    { name: 'Mansoor Delane', position: 'CB', school: 'Virginia Tech', rank: 24, edp: 20.5, height: "6'2\"", weight: 195, forty: '4.40', analysis: 'Most instinctive CB in class.', strengths: ['Ball skills', 'Instincts', 'Press coverage'] },
    { name: 'CJ Allen', position: 'LB', school: 'Georgia', rank: 25, edp: 24.6, height: "6'1\"", weight: 235, forty: '4.50', analysis: 'Three-down LB with excellent read-react.', strengths: ['Read-react', 'Physicality', 'Coverage'] },
    { name: 'Denzel Boston', position: 'WR', school: 'Washington', rank: 26, edp: 21.3, height: "6'4\"", weight: 205, forty: '4.50', analysis: 'Big-framed wideout with exceptional ball skills.', strengths: ['Size', 'Deep threat', 'Contested catches'] },
    { name: 'Emmett Johnson', position: 'RB', school: 'Nebraska', rank: 27, edp: 29.5, height: "6'0\"", weight: 210, forty: '4.50', analysis: 'Special lateral agility with elite vision.', strengths: ['Vision', 'Patience', 'Contact balance'] },
    { name: 'Dillon Thieneman', position: 'S', school: 'Oregon', rank: 28, edp: 28.4, height: "6'2\"", weight: 210, forty: '4.50', analysis: 'Tall, long safety with fantastic production.', strengths: ['Ball skills', 'Range', 'Tackling'] },
    { name: 'Kenyon Sadiq', position: 'TE', school: 'Oregon', rank: 29, edp: 31.2, height: "6'3\"", weight: 245, forty: '4.60', analysis: 'Versatile explosive weapon for modern NFL.', strengths: ['Athleticism', 'Mismatch', 'Hands'] },
    { name: 'Carson Beck', position: 'QB', school: 'Miami', rank: 30, edp: 22.1, height: "6'4\"", weight: 220, forty: '4.90', analysis: 'Physical tools have never been the question.', strengths: ['Size', 'Arm strength', 'Experience'] },
    { name: 'Daylen Everette', position: 'CB', school: 'Georgia', rank: 31, edp: 31.2, height: "6'0\"", weight: 190, forty: '4.42', analysis: 'Technique, experience, and physicality.', strengths: ['Technique', 'Experience', 'Physicality'] },
    { name: 'Luther Burden III', position: 'WR', school: 'Missouri', rank: 32, edp: 26.8, height: "5'11\"", weight: 200, forty: '4.45', analysis: 'Elite YAC ability with RB mentality.', strengths: ['YAC', 'Quickness', 'Slot ability'] }
];
